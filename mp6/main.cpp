                     ...
                     int pixelsPerTile, const string& outFile)
{
    ...
    cerr << "Done" << endl;
    delete mosaic;
    // delete tiles here below
    for(unsigned i=0;i<tiles.size();++i) delete tiles[i];
}
...
vector<TileImage*> getTiles(string tileDir)
{
    ...
    for (size_t i = 0; i < imageFiles.size(); i++) {
        ...
        TileImage * next = new TileImage(png); // changed to ptrs
    ...
    *temp(0, 0) = RGBAPixel(0,   0,   0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   0,   127); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   0,   255); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   127, 0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   255, 0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(127, 0,   0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(255, 0,   0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   127, 127); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(0,   255, 255); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(127, 0,   127); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(255, 0,   255); tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(127, 127, 0);   tiles.push_back(new TileImage(temp));
    *temp(0, 0) = RGBAPixel(255, 255, 0);   tiles.push_back(new TileImage(temp));
    return tiles;
#endif
}
